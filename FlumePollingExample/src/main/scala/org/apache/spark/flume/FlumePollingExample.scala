...
object FlumePollingExample {
  def main(args: Array[String]) {
    ...
    val sparkConf = new SparkConf().setAppName("FlumePollingExample")
    ...
    }.saveAsTextFiles("/user/hari/testF")
